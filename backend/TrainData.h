...
MEXPORT class BarClassCategor : public IBarClassCategor
{
public:
	bool show = true;
	BackColor color;
...
MEXPORT class BarCategories // : IBarCategories
{
	int counter = 0;
...
MEXPORT class BarClassifierDataIO
{
public:
