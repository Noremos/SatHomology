...
MEXPORT class VectorLayer : public IVectorLayer
{
	int binId = -1;
...
MEXPORT class MultiVectorLayer : public IVectorLayer
{
public:
	std::vector<DrawPrimitive> primitives;
...
MEXPORT class TreeVectorLayer : public VectorLayer
{
public:
	VecTree tree;
...
MEXPORT class ClassVectorLayer : public VectorLayer
{
public:
