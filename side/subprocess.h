...
subprocess_weak int subprocess_create(const char** command_line,
                                      int options,
...
subprocess_weak int
subprocess_create_ex(const char ** command_line, int options,
...
int subprocess_create_ex(const char** commandLine, int options,
                         const char *const environment[],
                         struct subprocess_s *const out_process) {
#if defined(_WIN32)
  int fd;
