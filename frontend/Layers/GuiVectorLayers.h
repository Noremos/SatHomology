...
MEXPORT class VectorGuiLayer : public VectorBaseLayer<VectorLayer>
{
public:
...
MEXPORT class TreeVectorGuiLayer;
...
MEXPORT class ClassVectorGuiLayer : public VectorBaseLayer<ClassVectorLayer>
{
