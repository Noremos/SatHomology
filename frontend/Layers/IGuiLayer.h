...
MEXPORT class ILayerWorker;

//GuiBackend backend;

MEXPORT class IGuiLayer
{
protected:
	BackString strId;
...
MEXPORT class LayerFactory : public CoreLayerFactory
{
private:
	static inline FunctionGuiHolder<IGuiLayer> guiLayersCreators;
