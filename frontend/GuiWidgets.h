...
// MEXPORT using LocalDisplayPS = CDDisplayPS;
// MEXPORT using GlobalDisplayPS = CDDisplayPS;
...
MEXPORT class GuiDrawInfo
{
	ImVec2 csPos;
	ImVec2 size;
};

MEXPORT class GuiResizableContainer
{
...
MEXPORT class GuiCSDisplayContainer
{
public:
...
MEXPORT class GuiDrawImage : public GuiImage
{
public:
...
MEXPORT class GuiDrawCloudPointClick : public GuiDrawImage
{
...
MEXPORT class ProjectionSettings
{
