...
MEXPORT inline void ResizeImage(int& width, int& height, int max_width, int max_height)
{
...
MEXPORT inline void ResizeImage(ImVec2& size, const ImVec2& maxSize)
{
	// Calculate the aspect ratio of the image
...
MEXPORT inline void ResizeImage(BackPoint& size, const BackPoint& maxSize)
{
	// Calculate the aspect ratio of the image
...
MEXPORT using ApplicationVec2 = ImVec2;
MEXPORT using WindowVec2 = ImVec2; // The top-left is a begin window
MEXPORT using ItemVec2 = ImVec2; // The top-left is an Item (image) coords

MEXPORT struct TextureId
{
	GLuint textureId;
	~TextureId();
};

MEXPORT inline ImVec2 toIV(const BackPoint& p)
{
	return ImVec2(p.x, p.y);
}

MEXPORT inline BackPoint toBP(const ImVec2& p)
{
...
MEXPORT class GuiItem
{

};

MEXPORT class GuiDisplaySystem
{
public:
	DisplaySystem& core;
